...
소크라테스 AI(이하 서비스)의 구독 취소 및 환불은 아래 규정에 따라 처리됩니다. 본 규정은 「전자상거래 등에서의 소비자 보호에 관한 법률」 및 관련 법령에 근거합니다.

## 제1조 (구독 취소)
① 이용자는 언제든지 구독을 취소할 수 있습니다.
...
## 제4조 (회사 귀책 사유 시 보상)
회사의 고의 또는 중과실로 유료 서비스 정상 이용이 불가한 경우, 이용자 요청 시 이용 불가 기간에 상당하는 금액을 보상합니다.

## 제5조 (청약철회 특례)
① 디지털 콘텐츠의 특성상 서비스를 실제 이용한 경우 전자상거래법 제17조에 따른 청약철회가 제한될 수 있습니다.
② 서비스 내용이 표시·광고와 다르거나 계약 내용과 다르게 이행된 경우, 이용 후 3개월 이내 또는 그 사실을 안 날부터 30일 이내에 청약철회를 할 수 있습니다.

## 제6조 (환불 처리 절차)
① 환불 신청: darbi0518@gmail.com으로 이메일 접수
